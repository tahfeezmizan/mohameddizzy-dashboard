            ...
            <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
                <div className="max-w-md w-full text-center space-y-6">
                    ...
                    <div className="space-y-2">
                        ...
                        <p className="text-slate-500">This referral link is invalid or has expired.</p>
                    </div>
                </div>
            </div>
        );
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 px-4">
            <div className="max-w-md w-full text-center space-y-8">
                ...
                <div className="space-y-2">
                    <h1 className="text-2xl font-bold text-slate-900">Opening Djarna...</h1>
                    <p className="text-slate-500">{data?.data?.referrerName ? `You were invited by ${data.data.referrerName}!` : "You were invited to join Djarna!"}</p>
                </div>
                ...
                {showAppStores && (
                    <div className="space-y-4 pt-4">
                        ...
                        <div className="flex flex-col gap-3">
                            ...
                            {!isAndroid && !isIOS && <p className="text-sm text-slate-400">Please visit us on your mobile device.</p>}
                        </div>
                    </div>
                )}
            </div>
