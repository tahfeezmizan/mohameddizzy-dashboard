          ...
          <table className="w-full text-sm text-left">
            <thead className="bg-slate-50 text-slate-500 font-semibold border-b border-slate-200">
              <tr>
                ...
                <th className="px-6 py-4 uppercase text-xs tracking-wider border-l border-slate-100">
                  Subcategories
                </th>
                <th className="px-6 py-4 uppercase text-xs tracking-wider">
                  Active Listings
                ...
                >
                  ...
                  <td className="px-6 py-4 text-right">
                    <div className="flex items-center justify-end gap-3 font-medium">
                      <Button
                        onClick={() => setOpen(true)}
                        className="bg-transparent text-blue-600 font-medium hover:text-blue-700"
                      >
                        Edit
                      </Button>
                      <Button className="bg-transparent text-red-500 hover:text-red-700 transition-colors">
                        Disable
                      </Button>
                    </div>
                  </td>
