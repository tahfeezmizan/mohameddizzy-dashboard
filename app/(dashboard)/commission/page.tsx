      ...
      <div className="rounded-xl bg-blue-50 border border-blue-100 p-4 flex gap-3 text-sm text-blue-800 items-start ">
        ...
        <div>
          ...
          <p className="text-blue-700">
            👉 Commission becomes available after delivery confirmation + 72h
            dispute window. This ensures fair resolution of any potential
            disputes.
          </p>
        </div>
      </div>

      <CommissionHistoryTable data={commissionHistory} />
