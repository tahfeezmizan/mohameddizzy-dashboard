...
import { useGetActivitiesQuery, TActivity } from "../../redux/features/activity/activityApi";
...
export function RecentActivityFeed() {
  ...
  return (
    <Card className="col-span-1 lg:col-span-2 shadow-sm border-slate-200 flex flex-col h-full">
      ...
      <CardContent className="flex flex-col gap-3 flex-1 overflow-y-auto max-h-[400px] scrollbar-thin scrollbar-thumb-slate-200">
