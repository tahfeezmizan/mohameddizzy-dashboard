...
import { DollarSign, LayoutDashboard, List, LogOut, Scale, Settings, ShoppingCart, Users, Zap, ShieldCheck, CreditCard, Flag } from "lucide-react";
...
export function Sidebar() {
    ...
    const navItems = [
        ...
        { name: t("sidebar.reports"), href: "/reports", icon: Flag },
